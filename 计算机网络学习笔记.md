...
ping是应用层之恶杰使用网络层的ICMP协议，没有使用TCP/UDP。

![img](https://ss.csdn.net/p?https://mmbiz.qpic.cn/mmbiz/yNKv1P4Q9eUMkKtiawTALIBxYU2OZiatV35icoonmSEARAPJPorb0ibvkgkvUSxEeEgxeKFjm72W0Mtxtfk9Q1LiawQ/640?wx_fmt=other)

1. 构建一个ICMP回送请求消息数据包，`类型 = 8`，`序号 =1 `实则是ip数据包；

   <img src="E:\CS\cs-note\img\icmp.jpg" alt="image-20200704202900651" style="zoom:80%;" />

2. 将得到的MAC地址封装到IP数据包中

![image-20200704203021691](E:\CS\cs-note\img\MAC.jpg)
...
![DNS解析.png](https://i.loli.net/2020/06/27/FUW7G6orCVfugdc.png)
...
![image-20200625213238443](./img/访问url)
...
<img src="./img/缓存" alt="image-20200626113153955" style="zoom:80%;" />
...
<img src="./img/contact.jpg" alt="02" style="zoom: 67%;" />
